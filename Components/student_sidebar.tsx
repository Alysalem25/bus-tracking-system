...
const driver_sidebar = ({ sidebarOpen, setSidebarOpen , active  }) => {
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
            <h2 className="admin_panel_h2 text-xl font-bold text-gray-900 dark:text-white">Student Panel</h2>
            <button
              onClick={() => setSidebarOpen(false)}
              className="lg:hidden text-gray-500 hover:text-gray-700 dark ThempatibleADMIN Sidebar<|fim_middle|>:text-gray-400"
            >
