      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
            <h2 className="admin_panel_h2 text-xl font-bold text-gray-900 dark:text-white">Admin Panel</h2>
            <button
              onClick={() => setSidebarOpen(false)}
          ...
          <nav className="flex-1 overflow-y-auto p-4">
            <ul className="space-y-2">
              ...
              <li   onClick={() => setActive("stations")} className={Active === "stations" ? "bg-gray-200 dark:bg-gray-700 rounded-lg" : ""}>
                <Link
              ...
              <li onClick={() => setActive("route")} className={Active === "route" ? "bg-gray-200 dark:bg-gray-700 rounded-lg" : ""}>
                <Link
              ...
              <li  onClick={() => setActive("students")} className={Active === "students" ? "bg-gray-200 dark:bg-gray-700 rounded-lg" : ""}>
                <Link
              ...
              <li onClick={() => setActive("drivers")} className={Active === "drivers" ? "bg-gray-200 dark:bg-gray-700 rounded-lg" : ""}>
                <Link
              ...
              <li onClick={() => setActive("reports")} className={Active === "reports" ? "bg-gray-200 dark:bg-gray-700 rounded-lg" : ""}>
                <a
                  href="#"
                  className="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                >
